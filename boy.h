...
#define BOY_SESSION_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), BOY_TYPE, Boy))
#define BOY_IS_SESSION(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), BOY_TYPE))
#define BOY_IS_SESSION_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), BOY_TYPE))
#define BOY_SESSION_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), BOY_TYPE, BoyClass))
